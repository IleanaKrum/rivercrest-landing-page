...
## Completed - Automated Certificate Generation (Current Session)
- [x] Implement submitQuiz procedure with automatic certificate generation
  - [x] Store quiz results in database
  - [x] Calculate scores and check 70% passing threshold
  - [x] Automatically generate PDF certificates on pass
  - [x] Send certificates via email with PDF attachment
  - [x] Create certificate records in database
  - [x] Add error handling (non-blocking)
- [x] Add database functions for quiz results
  - [x] createQuizResult function
  - [x] getQuizResultsByUserId function
  - [x] getQuizResultsByModuleId function
- [x] Add tRPC procedures for student certificates
  - [x] getStudentCertificates - fetch user's certificates
  - [x] getCertificateByVerificationCode - public verification
- [x] Build StudentCertificates page
  - [x] Display all earned certificates
  - [x] Download certificate functionality
  - [x] Share certificate functionality
  - [x] Certificate metadata display
- [x] Build CertificateVerification page
  - [x] Public certificate verification portal
  - [x] Search by verification code
